            ...
            <div className="bg-gradient-to-t from-blue-200 via-blue-400 to-blue-600 min-h-screen">
                ...
                <div className="container mx-auto py-12 px-4">
                    <div className="text-center mb-10">
                        <h1 className="text-4xl font-bold text-white">Explore Our Courses</h1>
                        <p className="mt-4 text-lg text-gray-200">Find the perfect course for you from our wide selection of categories</p>
                    </div>
