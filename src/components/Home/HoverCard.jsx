...
const HoverCard = ({ title, description, ruta }) => {
  return (
      <div className="relative border-2 border-b-gray-600 group cursor-pointer overflow-hidden lg:px-3 py-3 rounded-md bg-gradient-to-br from-blue-500 to-purple-500 text-gray-50">
        <div>
          <div className="group-hover:scale-110 h-44 w-full duration-500">
            <img src={ruta} alt="Aqui va una" className="object-cover w-full h-full" style={{ objectFit: 'cover' }} />
          </div>
          <div className="absolute w-full h-56 left-0 -bottom-20 right-0 duration-500 group-hover:-translate-y-1/4">
            ...
            <span className=" mt-2 text-xl font-black text-white justify-center flex duration-500 group-hover:opacity-100 opacity-0 ">{title}</span>
