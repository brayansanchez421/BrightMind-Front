...
const SettingsBar = () => {
  ...
  return (
    <div className="w-96 mt-36 md:ml-28 md:mr-4 bg-gradient-to-r from-violet-500 to-fuchsia-400 rounded-lg shadow-2xl shadow-rose-400 md:px-10 py-4">
      ...
      <ul className="list-disc pl-2 md:pl-4">
        ...
        <li className='text-base mt-1 hover:bg-red-600 py-1 font-bold'>
