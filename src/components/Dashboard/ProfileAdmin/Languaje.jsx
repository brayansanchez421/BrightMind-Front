...
const LanguagePreferences = () => {
  ...
  return (
    <>
      <div className='text-left px-4 font-bold py-1 hover:bg-sky-500 rounded-lg'><a href="#" onClick={handleOpenModal}>Language preferences</a></div>
      ...
      {showModal && (
        <div className="text-lg font-medium shadow-md text-center py-1 mt-1 rounded-md">
          ...
          <div className='mb-4 mt-4 text-sm text-black'>
            <select>
