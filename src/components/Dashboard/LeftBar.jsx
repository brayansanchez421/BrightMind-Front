...
const LeftBar = ({ onVisibilityChange }) => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 h-full bg-gradient-to-t from-purple-800 to-teal-400 text-white flex flex-col items-center shadow-xl shadow-blue-100 transition-transform duration-300 ${
